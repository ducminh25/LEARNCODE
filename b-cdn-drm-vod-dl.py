...
if __name__ == '__main__':
    video = BunnyVideoDRM(
        ...
        referer='https://www.monfansubvn.com/',
        # paste your embed link
        embed_url='https://iframe.mediadelivery.net/embed/152358/9fa04075-a0ed-4715-a223-d102f944819d',
        # you can override file name, no extension
        name="",
        # you can override download path
        path=r"D:\Minh\Downloaded file\Video")
    # video.session.close()
    video.download()


# https://video.twimg.com/amplify_video/1960938094649335813/vid/avc1/0/0/1920x1080/GjxAPCdepKiwTneR.mp4
# https://video.twimg.com/amplify_video/1960938094649335813/pl/avc1/1920x1080/YQnayCe1x-hL7I__.m3u8